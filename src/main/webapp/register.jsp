...
<body class="crm_body_bg">
      ...
      <nav class="sidebar dark_sidebar">
        ...
        <ul id="sidebar_menu">
            ...
            <li class>
                <a href="wallet.jsp" aria-expanded="false">
                    <div class="nav_icon_small">
            ...
            <li class>
                <a href="send_money.jsp" aria-expanded="false">
                    <div class="nav_icon_small">
            ...
            <li class>
                <a href="Profile.jsp" aria-expanded="false">
                    <div class="nav_icon_small">
						...
						<div
							...
							<div class="header_notification_warp d-flex align-items-center">
								<li><a class="CHATBOX_open nav-link-notify"
									href="resister.jsp#"> <img src="img/icon/msg.svg" alt>
								</a></li>
								<li><a class="bell_notification_clicker nav-link-notify"
									href="resister.jsp#"> <img src="img/icon/bell.svg" alt>
									...
									<div class="Menu_NOtification_Wrap">
										...
										<div class="Notification_body">
											...
											<div class="single_notify d-flex align-items-center">
												<div class="notify_thumb">
													<a href="resister.jsp#"><img src="img/staf/2.png" alt></a>
												</div>
												<div class="notify_content">
													<a href="resister.jsp#"><h5>Cool Marketing</h5></a>
											...
											<div class="single_notify d-flex align-items-center">
												<div class="notify_thumb">
													<a href="resister.jsp#"><img src="img/staf/4.png" alt></a>
												</div>
												<div class="notify_content">
													<a href="resister.jsp#"><h5>Awesome packages</h5></a>
													<p>Lorem ipsum dolor sit amet</p>
												</div>
											</div>
											...
											<div class="single_notify d-flex align-items-center">
												<div class="notify_thumb">
													<a href="resister.jsp#"><img src="img/staf/3.png" alt></a>
												</div>
												<div class="notify_content">
													<a href="resister.jsp#"><h5>what a packages</h5></a>
													<p>Lorem ipsum dolor sit amet</p>
												</div>
											</div>
										...
										<div class="nofity_footer">
											<div class="submit_button text-center pt_20">
												<a href="resister.jsp#" class="btn_1 green">See More</a>
											</div>
										</div>
									</div></li>
							</div>
							<div class="profile_info d-flex align-items-center">
								...
								<div class="profile_info_iner">
									...
									<div class="profile_info_details">
										<a href="resister.jsp#">My Profile </a> <a
											href="resister.jsp#">Settings</a> <a href="resister.jsp#">Log
											Out </a>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="dashboard_breadcam text-end">
										<p>
											<a href="index.jsp">Dashboard</a> <i
												class="fas fa-caret-right"></i> Register
										</p>
									</div>
								</div>
							</div>
											...
											<form method="post" action="RegisterServlet">
												...
												<div class=" cs_check_box">
													<input type="checkbox" id="check_box"
														class="common_checkbox"> <label class="form-label"
														for="check_box"> Keep me up to date </label>
												</div>
												<button class="btn_1 full_width text-center">Sign
													Up</button>
												<%
												...
												%>
												<p>
													Need an account? <a href="login.jsp">Log in</a>
												</p>
												<div class="text-center">
													<a href="forgot_pass.jsp" class="pass_forget_btn">Forget
														Password?</a>
												</div>
											</form>
										</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="footer_iner text-center">
							<p>
								2020 © Influence - Designed by <a href="resister.jsp#"> <i
									class="ti-heart"></i>
								</a><a href="resister.jsp#"> DashboardPack</a>
							</p>
						</div>
					</div>
				</div>
...
<path
	...
	<div id="back-top" style="display: none;">
		<a title="Go to Top" href="resister.jsp#"> <i class="ti-angle-up"></i>
		</a>
	</div>
