...
ArrayList<String[]> sendMoneyHistory = (ArrayList<String[]>) session.getAttribute("sendMoneyHistory");
...
<body class="crm_body_bg">
	...
	<section class="main_content dashboard_part large_header_bg">
							...
							<div class="header_notification_warp d-flex align-items-center">
								...
								<li>
									<button type="button" class="refreshbutton"
										onclick="window.location.href='SendMoneyEntry';">
									...
									<div class="Menu_NOtification_Wrap">
										...
										<div class="nofity_footer">
											<div class="submit_button text-center pt_20">
												<a href="buy_sell.jsp#" class="btn_1 green">See More</a>
											</div>
										</div>
									</div></li>
							</div>
							<div class="profile_info d-flex align-items-center">
								...
								<div class="profile_info_iner">
									...
									<div class="profile_info_details">
										<a href="buy_sell.jsp#">My Profile </a> <a
											href="buy_sell.jsp#">Settings</a> <a href="LogoutServlet">Log
											Out </a>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-8">
						<div class="white_card card_height_100 mb_30">
							...
							<form action="SendMoneyServlet" method="POST">
									...
									<div class="row">
										<div class="col-lg-6">
											...
											<div class="common_input mb_20">
												<input name="receiverName" type="text" placeholder="Name"
													required>
											</div>
										</div>
										<div class="col-lg-6">

											<div class="common_input mb_20" style="position: relative;">
												<label class="form-label">Account number</label> <input
													name="receiverAccountNo" id="receiverAccountNo"
											...
											<div id="verificationMessage" style="margin-top: 5px;"></div>
										</div>
										...
										<div class="col-lg-6">
											<div class="common_input mb_20">
												<label class="form-label">Description</label> <input
													name="senderDescription" type="text"
													placeholder="Description" value="Gift">
											</div>
										</div>
										<div class="col-lg-6">
											...
											<div class="input-group ">
												<select name="currency" class="form-control nice_Select">
													<option data-display="BitPay Wallet" value="BitPay Wallet">BitPay
														Wallet</option>
													<option value="State Bank">State Bank</option>
												</select> <input type="number" name="sendingAmount"
										...
										<div class="col-12">
										  ...
										  <button type="button"  class="btn_1 w-100" onclick="showPinPopup()">Send</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div id="pinpopup-container" class="pinpopup-container" style="display:none;">
									<div class="pinpopup">
									<h3 style="margin-left:92%;"><a href="">x</a></h3>
										<div class="pincontent">
											<p>BitPay PIN</p>
											<div class="pininp">
												<!-- OTP Verification Input -->
                                              <input name="senderPin1" placeholder="" type="text" class="pininput" maxlength="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
												<!-- OTP Verification Input -->
                                              <input name="senderPin2"  placeholder="" type="text" class="pininput" maxlength="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
												<!-- OTP Verification Input -->
                                              <input name="senderPin3"  placeholder="" type="text" class="pininput" maxlength="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
												
												<!-- OTP Verification Input -->
                                              <input name="senderPin4"  placeholder="" type="text" class="pininput" maxlength="1" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
								...
								<!-- OTP Verification Form HTML end-->
								<script>function showPinPopup() {
									   document.getElementById("pinpopup-container").style.display = "flex";
								 }
						...
						<div class="white_card card_height_100 mb_30">
							...
							<div class="white_card_body">
								<div class="exchange_widget">
									<form action="SendRequestServlet" class="currency_validate"
										method="post">
										<div class="form-group">
											<label class="form-label">Name</label>
											<div class="common_input ">
												<input name="requestName" type="text" placeholder="Name">
											</div>
										</div>
										<div class="form-group">
											<label class="form-label">Account Number</label>
											<div class="common_input ">
												<input name="requestAccountNo" type="number"
													placeholder="Account">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="common_input ">
												<input name="requestDescription" type="text"
										...
										<div class="form-group">
											...
											<div class="common_input ">
												<input name="requestAmount" type="number"
													placeholder="Amount">
											</div>
										</div>

										<button type="submit" name="submit" class="btn_1 w-100">Request</button>
									</form>
								</div>
							</div>
						</div>
								...
								<div class="QA_section">
									<div class="QA_table mb_30">
										...
										<table class="table lms_table_active3 "  data-ordering="false" >
											...
											<tbody>
												<%
												for (int i = sendMoneyHistory.size() - 1; i >= 0; i--) {
													String transactionId = sendMoneyHistory.get(i)[0];

													String receiverName = sendMoneyHistory.get(i)[1];

													String receiverAcc = sendMoneyHistory.get(i)[2];
													String amount = sendMoneyHistory.get(i)[3];
													String status = sendMoneyHistory.get(i)[4];
													String time = sendMoneyHistory.get(i)[5];
													String note = sendMoneyHistory.get(i)[6];
													String action = sendMoneyHistory.get(i)[7];
													String description = sendMoneyHistory.get(i)[8];
													...
													if (status.equalsIgnoreCase("failed") ||status.equalsIgnoreCase("Declined")) {
														badge = "danger";
													}
												...
												%>
												<tr
													onclick="showPopup('<%=transactionId%>', '<%=receiverName%>', '<%=receiverAcc%>', '<%=amount%>', '<%=time%>', '<%=status%>', '<%=description%>', '<%=note%>')">

													<td>
														<div class="trade d-flex align-items-center">
															<img src="img/currency/1.svg" alt> <span
																class="ms-3"> <%=receiverName%>
															</span>
														</div>
													</td>
		...
		<div class="popup" style="display: none;">
			...
			<div class="popup-right">
				...
				<div class="popup-body">
					...
					<div class="detail-item">
						<span>Fee</span> <span id="popup-account">Rs0.0</span>
					</div>
					...
					<div class="detail-item detail-block">
						<span>Sent To</span> <span id="popup-name" class="detail-value">Name</span>
						<span id="popup-accountNo" class="detail-value">0</span>
					</div>
					<div class="detail-item detail-block">
					...
					<div class="detail-item detail-block">
						<span>Message</span> <span id="popup-description"
							class="detail-value">Hii</span>
					</div>
					<div class="detail-item detail-block">
		...
		<script>
			...
			function showPopup(transactionId, receiverName, receiverAccount,
					amount, time, status, description, note) {
				...
				document.getElementById('popup-total').textContent = '₹'
						+ amount;
				document.getElementById('popup-name').textContent = receiverName;
				document.getElementById('popup-accountNo').textContent = 'Acc No :-'
						+ receiverAccount;
		...
		<!--------------------------- payment success failed popup  ---------------------->
		<%
		String error = request.getParameter("error");
		String sendMoneyStatus = request.getParameter("sendMoneyStatus");
		String requestMoneyStatus = request.getParameter("requestMoneyStatus");
		String transactionId = request.getParameter("transactionId");
		%>


		<!----------- payment success popup  ------------------>
		<div id="success-popup" class="payment-container"
			style="display: none;">
			...
			<div class="paper-container">
				...
				<div class="paper">
					<div class="main-contents">
						<a href="SendMoneyEntry" class="close-button"
							onclick="closePopup('success-popup')">&times;</a>
						<!-- Close button -->
						<div class="success-icon">&#10004;</div>
						<div id="success-title" class="success-title">Payment
							Complete</div>
						<div class="success-description">
							<%=error%>
						</div>
						<div class="order-details">
							<div id="success-id" class="order-number-label">Payment ID</div>
		...
		<div id="error-popup" class="payment-container" style="display: none;">
			<div class="printer-top"></div>
			<div class="paper-container">
				<div class="printer-bottom"></div>
				<div class="paper">
					<div class="main-contents">
						<a href="SendMoneyEntry" class="close-button"
							onclick="closePopup('error-popup')">&times;</a>
						<!-- Close button -->
						<div class="success-icon" style="background: #ff0000;">&#10008;</div>
		...
		if (error != null && !error.isEmpty()) {
			if ("success".equals(sendMoneyStatus)) {
				status = "success";
			} else if ("failed".equals(sendMoneyStatus)) {
				status = "error";
			} else if ("success".equals(requestMoneyStatus)) {
				status = "requestSuccess";
			} else if ("failed".equals(requestMoneyStatus)) {
				status = "requestError";
			}
		}
		%>
		...
		<%} else if ("requestSuccess".equals(status)) {%>
			document.getElementById('success-title').textContent = 'Request Send Success';
			document.getElementById('success-popup').style.display = 'block';
		<%} else if ("requestError".equals(status)) {%>
			document.getElementById('success-title').textContent = 'Request Send Failed';
			document.getElementById('error-popup').style.display = 'block';
		<%}%>
		...
		<!--------------------------- payment success failed popup end ---------------------->
	</section>
	...
	<div id="back-top" style="display: none;">
		<a title="Go to Top" href="buy_sell.jsp#"> <i class="ti-angle-up"></i>
		</a>
	</div>
	...
	if (toastHistory != null) {
		for (int i = 0; i < toastHistory.size(); i++) {
			...
			String currentPage = "send_money.jsp";
	%>
