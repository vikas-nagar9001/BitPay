						...
						<div
							...
							<div class="header_notification_warp d-flex align-items-center">
								<li><a class="CHATBOX_open nav-link-notify"
									href="login.jsp#"> <img src="img/icon/msg.svg" alt>
								</a></li>
								<li><a class="bell_notification_clicker nav-link-notify"
									href="login.jsp#"> <img src="img/icon/bell.svg" alt>
									...
									<div class="Menu_NOtification_Wrap">
										...
										<div class="Notification_body">
											...
											<div class="single_notify d-flex align-items-center">
												<div class="notify_thumb">
													<a href="login.jsp#"><img src="img/staf/2.png" alt></a>
												</div>
												<div class="notify_content">
													<a href="login.jsp#"><h5>Cool Marketing</h5></a>
											...
											<div class="single_notify d-flex align-items-center">
												<div class="notify_thumb">
													<a href="login.jsp#"><img src="img/staf/4.png" alt></a>
												</div>
												<div class="notify_content">
													<a href="login.jsp#"><h5>Awesome packages</h5></a>
													<p>Lorem ipsum dolor sit amet</p>
												</div>
											</div>
											...
											<div class="single_notify d-flex align-items-center">
												<div class="notify_thumb">
													<a href="login.jsp#"><img src="img/staf/3.png" alt></a>
												</div>
												<div class="notify_content">
													<a href="login.jsp#"><h5>what a packages</h5></a>
													<p>Lorem ipsum dolor sit amet</p>
												</div>
											</div>
										...
										<div class="nofity_footer">
											<div class="submit_button text-center pt_20">
												<a href="login.jsp#" class="btn_1 green">See More</a>
											</div>
										</div>
									</div></li>
							</div>
							<div class="profile_info d-flex align-items-center">
								...
								<div class="profile_info_iner">
									...
									<div class="profile_info_details">
										<a href="login.jsp#">My Profile </a> <a href="login.jsp#">Settings</a>
									...
									<div class="dashboard_breadcam text-end">
										<p>
											<a href="index.jsp">Dashboard</a> <i
												class="fas fa-caret-right"></i> login
										</p>
									</div>
								</div>
							</div>
									...
									<div class="modal-content cs_modal">
										...
										<div class="modal-body">
											<form method="post" action="LoginServlet">
												...
												%>
												<p>
													Need an account? <a href="register.jsp"> Sign Up</a>
												</p>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="footer_iner text-center">
							<p>
								2020 © Influence - Designed by <a href="login.jsp#"> <i
									class="ti-heart"></i>
								</a><a href="login.jsp#"> DashboardPack</a>
							</p>
						</div>
					</div>
				</div>
...
<path
	...
	<div id="back-top" style="display: none;">
		<a title="Go to Top" href="login.jsp#"> <i class="ti-angle-up"></i>
		</a>
	</div>
