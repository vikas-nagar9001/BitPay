...
ArrayList<String[]> showAllHistory = (ArrayList<String[]>) session.getAttribute("showAllHistory");
...
<body class="crm_body_bg">
 ...
 <nav class="sidebar dark_sidebar">
        <div class="logo d-flex justify-content-between">
            <a class="large_logo" href="index.jsp"><img src="img/logo_white.png" alt></a>
            <a class="small_logo" href="index.jsp"><img src="img/mini_logo.png" alt></a>
        ...
        <ul id="sidebar_menu">
            ...
            <li class>
                <a href="WalletEntry" aria-expanded="false">
                    <div class="nav_icon_small">
            ...
            <li class>
                <a href="SendMoneyEntry" aria-expanded="false">
                    <div class="nav_icon_small">
            ...
            <li class>
                <a href="ProfileEntry" aria-expanded="false">
                    <div class="nav_icon_small">
                    ...
                    <div class="header_iner d-flex justify-content-between align-items-center">
                        ...
                        <div class="header_right d-flex justify-content-between align-items-center">
                            <div class="header_notification_warp d-flex align-items-center">
                            	<!----------refesh button-------------------->
								<li>
									<button type="button" class="refreshbutton"	onclick="window.location.href='TransactionHistoryEntry';">
                                    ...
                                    <div class="Menu_NOtification_Wrap">
                                      <div class="notification_Header"
                                            ...
                                            <h4>Notifications</h4>
												...
												onclick="window.location.href='TransactionHistoryEntry';">
											<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
											fill="currentColor" class="bi bi-arrow-repeat"
											viewBox="0 0 16 16">
                                              <path
                                       ...
                                       <div class="Notification_body">
                                        ...
                                        <div class="nofity_footer">
                                            <div class="submit_button text-center pt_20">
                                                <a href="Request.jsp#" class="btn_1 green">See More</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="profile_info d-flex align-items-center">
                                ...
                                <div class="profile_info_iner">
                                    ...
                                    <div class="profile_info_details">
                                        <a href="Request.jsp#">My Profile </a>
                                        <a href="Request.jsp#">Settings</a>
                                    ...
                                    <div class="QA_table mb_30">
                                        ...
                                        <table class="table lms_table_active3 "  data-ordering="false" >
                                            ...
                                            <tbody>
												...
												for (int i = showAllHistory.size()-1; i >=0; i--) {
													String transactionId = showAllHistory.get(i)[0];
													String Name = showAllHistory.get(i)[1];
													
													String AccountNo = showAllHistory.get(i)[2];
													String amount = showAllHistory.get(i)[3];
													String status = showAllHistory.get(i)[4];
													String time = showAllHistory.get(i)[5];
													String note = showAllHistory.get(i)[6];
													String action = showAllHistory.get(i)[7];
													String description = showAllHistory.get(i)[8];
												...
												%>
												   <tr onclick="showPopup('<%=transactionId%>', '<%=Name%>', '<%=AccountNo%>', '<%=amount%>', '<%=time%>', '<%=status%>','<%=description%>', '<%=note%>','<%=action%>')">
          ...
          <!-------Transaction Detail view pop up------------->
                    ...
                    <div class="popup" style="display: none;">
                        <div class="popup-left">
                            <a href="#" class="company-logo"> <img src="img/mini_logo.png" alt="Company Logo">
                            </a>
                            <h2>Bit Pay</h2>
                        ...
                        <div class="popup-right">
                            ...
                            <div class="popup-body">
                                ...
                                <div class="detail-item detail-block">
                                    <span id="popup-name-heading">Sent To/By</span> <span id="popup-name" class="detail-value">Name</span>
                                ...
                                <div class="detail-item detail-block">
                                 ...
                                 <div class="detail-item detail-block">
                                    <span>Message</span> <span id="popup-description" class="detail-value">Hii</span>
                                </div>
                                <div class="detail-item detail-block">
                                    <span>Note</span> <span id="popup-note" class="detail-value">Note</span>
                                </div>
                                <div class="detail-item detail-block">
                                    <span>Status</span> <span id="popup-status" class="detail-value completed">Completed
                                        &#x2714;</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <script>
                        ...
                        function showPopup(transactionId, Name,AccountNo, amount, time, status,description, note,action) {
                            ...
                            document.getElementById('popup-accountNo').textContent = 'Acc No :-' +AccountNo;
                            ...
                            //change send to send by and added by dynamically
                            if (action == 'Add Funds') {
                                document.getElementById('popup-name-heading').textContent = 'Added By';
                            } else if (action == 'Send Money') {
                                document.getElementById('popup-name-heading').textContent = 'Send To';
                            } else if (action == 'Received') {
                                document.getElementById('popup-name-heading').textContent = 'Received From';
                            }
    ...
    <div id="back-top" style="display: none;">
        <a title="Go to Top" href="Request.jsp#">
...
<!-- Toast notification -->
	...
	if (toastHistory != null) {
		for (int i = 0; i < toastHistory.size(); i++) {
			...
			String currentPage ="Transaction.jsp";
	%>
