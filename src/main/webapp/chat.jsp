...
<body class="crm_body_bg">
                                       ...
                                       <div class="Notification_body">
											...
											<div class="single_notify d-flex align-items-center">
												...
												<div class="notify_content">
													...
													<p><%=notificationHeading %> of â¹<%=notificationAmount %></p>
                                        ...
                                        <div class="nofity_footer">
                                            <div class="submit_button text-center pt_20">
                                                <a href="chat.jsp#" class="btn_1 green">See More</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="profile_info d-flex align-items-center">
                                ...
                                <div class="profile_info_iner">
                                    ...
                                    <div class="profile_info_details">
                                        <a href="chat.jsp#">My Profile </a>
                                        <a href="chat.jsp#">Settings</a>
                                        <a href="chat.jsp#">Log Out </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="dashboard_breadcam text-end">
                                        <p><a href="index.jsp">Dashboard</a> <i class="fas fa-caret-right"></i> Chat
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer_iner text-center">
                            <p>2020 Â© Influence - Designed by <a href="chat.jsp#"> <i class="ti-heart"></i> </a><a
                                    href="chat.jsp#"> DashboardPack</a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="back-top" style="display: none;">
        <a title="Go to Top" href="chat.jsp#">
