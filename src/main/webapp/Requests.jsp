...
ArrayList<String[]> requestHistory = (ArrayList<String[]>) session.getAttribute("requestHistory");
...
<body class="crm_body_bg">
					...
					<div
						...
						<div
							...
							<div class="header_notification_warp d-flex align-items-center">
								<!----------refesh button-------------------->
								<li>
									<button type="button" class="refreshbutton"	onclick="window.location.href='RequestEntry';">
								...
								<li><a class="CHATBOX_open nav-link-notify"
									href="#"> <img src="img/icon/msg.svg" alt>
								</a></li>
								<li><a class="bell_notification_clicker nav-link-notify"
									...
									<div class="notification_Header"
											...
											<button type="button" class="refreshicon"
												onclick="window.location.href='RequestEntry';">
											<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
											fill="currentColor" class="bi bi-arrow-repeat"
											viewBox="0 0 16 16">
                                              <path
										...
										<div class="Notification_body">
											...
											<div class="single_notify d-flex align-items-center">
												...
												<div class="notify_content">
													...
													<p><%=notificationHeading %> of ₹<%=notificationAmount %></p>
													<p>Msg :-<%=notificationMessage %></p>
												</div>
											</div>
											<%
											}
										...
										<div class="nofity_footer">
											<div class="submit_button text-center pt_20">
												<a href="Refound.jsp#" class="btn_1 green">See More</a>
											</div>
										</div>
									</div></li>
							</div>
							<div class="profile_info d-flex align-items-center">
								...
								<div class="profile_info_iner">
									...
									<div class="profile_info_details">
										<a href="Refound.jsp#">My Profile </a> <a href="Refound.jsp#">Settings</a>
					...
					<div class="col-12">
						<div
							...
							<div class="page_title_left d-flex align-items-center">
								<h3 class="mb-0">Payment Requests</h3>
							</div>
				...
				<div class="row">
							...
							<div class="white_card_header">
								<div class="box_header m-0">
									<div class="main-title">
										<h3 class="m-0"><%=requestHistory.size() %>+ Requests</h3>
									</div>
									<div class="header_more_tool">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right"
												...
												<a class="dropdown-item" href="Refound.jsp#"> <i
													class="ti-eye"></i> Action
												</a> <a class="dropdown-item" href="Refound.jsp#"> <i
					...
					<form action="SendMoneyServlet" method="POST">		
							...
							for(int i=requestHistory.size()-1;i>=0;i--){
								String requestSenderName = requestHistory.get(i)[0];
								String requestSenderAcc = requestHistory.get(i)[1];
								String requestAmount = requestHistory.get(i)[2];
								String requestMessage = requestHistory.get(i)[3];
								String requestTime = requestHistory.get(i)[4];
								String requestStatus = requestHistory.get(i)[5];
								String requestId = requestHistory.get(i)[6];
							...
							<div class="single__profile">
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="profile__name mb_20 d-flex align-items-center">
													...
													<h4 class="f_s_16 d_w_500 mb-0"><%=requestSenderName %></h4>
												</div>
											</div>
											<div class="col-lg-6 text-end">
												<div class="profile__review mb_20">
													<ul>
														<li><span class="profile__mark">₹</span> <%=requestAmount %></li>
														<li><span class="profile__mark orange">S</span>
															<%=requestStatus %></li>
														<li><span class="profile__mark green">D</span>
															<%=requestDate %></li>
													</ul>
												</div>
											</div>
									...
									<div class="profile__review_details mb_20">
										<span class="f_s_12 f_w_300 mb_10 d-block">Message</span>
	      						...
	      						<div class="profile__review_footer text-end">
										<a href="RequestDeclineServlet?requestId=<%=requestId %>" class="btn_1 sm mr_10">Decline</a> 
										<button
											type="button"  class="btn_1 sm green" onclick="showPinPopup()">Accept</button>
									</div>
									<%} %>
								</div>
								
								<!--in this we submit from so all attribute in input form  -->
								<!--so we set hidden input -->
								<input type="hidden" name="receiverName" value="<%=requestSenderName %>" >
								<input type="hidden" name="sendingAmount" value="<%=requestAmount %>" >
								<input type="hidden" name="receiverAccountNo" value="<%=requestSenderAcc %>" >
	     						<input type="hidden" name="senderDescription" value="<%=requestMessage %>" >
					        ...
					        <%} %>
								...
								<script>function showPinPopup() {
									...
									<!-- PIN Verification Form HTML end-->
								</form>
							</div>
						</div>
					</div>
	...
	<div id="back-top" style="display: none;">
		<a title="Go to Top" href="Refound.jsp#"> <i class="ti-angle-up"></i>
		</a>
	</div>
...
<!-- Toast notification -->
	...
	if (toastHistory != null) {
		for (int i = 0; i < toastHistory.size(); i++) {
			...
			String currentPage ="Requests.jsp";
	%>
