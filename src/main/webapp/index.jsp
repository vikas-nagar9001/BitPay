...
<body class="crm_body_bg">
						...
						<div
							...
							<div class="header_notification_warp d-flex align-items-center">
								...
								<li><a class="CHATBOX_open nav-link-notify"
									href="index.jsp#"> <img src="img/icon/msg.svg" alt>
								</a></li>
								<li><a class="bell_notification_clicker nav-link-notify"
									href="index.jsp#"> <img src="img/icon/bell.svg" alt>
									...
									<div class="Menu_NOtification_Wrap">
										...
										<div class="nofity_footer">
											<div class="submit_button text-center pt_20">
												<a href="index.jsp#" class="btn_1 green">See More</a>
											</div>
										</div>
									</div></li>
							</div>
							<div class="profile_info d-flex align-items-center">
								...
								<div class="profile_info_iner">
									...
									<div class="profile_info_details">
										<a href="index.jsp#">My Profile </a> <a href="index.jsp#">Settings</a>
								...
								<div class="box_header m-0">
									<ul class="nav  theme_menu_dropdown">
										<li class="nav-item"><a class="nav-link active"
											href="index.jsp#">Analytics</a></li>
										<li class="nav-item"><a class="nav-link"
											href="index.jsp#">Cryptocurrency</a></li>
										<li class="nav-item"><a class="nav-link"
											href="index.jsp#">Campaign</a></li>
										<li class="nav-item dropdown"><a
											class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
											href="index.jsp#" role="button" aria-haspopup="true"
											aria-expanded="false">More</a>
											<div class="dropdown-menu">
												<a class="dropdown-item" href="index.jsp#"> Ecommarce
													Analytics</a> <a class="dropdown-item" href="index.jsp#">
													Sales</a> <a class="dropdown-item" href="index.jsp#">
													Performance</a>
											</div></li>
									</ul>
									<div class="button_wizerd">
										<a href="index.jsp#" class="white_btn mr_5">ToDo</a> <a
											href="index.jsp#" class="white_btn">Settings</a>
									</div>
								</div>
							</div>
							...
							<div class="page_title_right">
								<div class="dropdown CRM_dropdown  mr_5 mb_10">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<a class="dropdown-item" href="index.jsp#">Today</a> <a
											class="dropdown-item" href="index.jsp#">This Week</a> <a
											class="dropdown-item" href="index.jsp#">Last week</a>
									</div>
								</div>
								<a href="index.jsp#" class="white_btn mb_10">Export</a>
							</div>
						</div>
					</div>
					<div class="col-xl-8">
						<div class="white_card   card_height_100 mb_30">
							<div class="white_card_header">
								<div class="box_header m-0 flex-wrap">
									...
									<div class="view_btns">
										<a href="index.jsp#" class="mr_5 mb_10  small_blue_btn active">All</a>
										<a href="index.jsp#" class="mr_5 mb_10  small_blue_btn active">1M</a>
										<a href="index.jsp#" class="mr_5 mb_10  small_blue_btn">6M</a>
										<a href="index.jsp#" class="mr_5 mb_10  small_blue_btn">1Y</a>
										<a href="index.jsp#" class="mr_5 mb_10  small_blue_btn">YTD</a>
									</div>
								</div>
							</div>
									...
									<div class="header_more_tool">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right"
												...
												</a> <a class="dropdown-item" href="index.jsp#"> <i
								...
								<div class="recent_transfer_wrapper">
									<div class="transfer_thumb_conatnt">
										...
										<div class="row">
											...
											<div class="col-12">
												<a href="index.jsp#" class="btn_1 w-100">Send Money</a>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="white_card_header">
										<div class="box_header m-0">
											...
											<div class="erning_btn d-flex">
												<a href="index.jsp#"
													class="small_blue_btn radius_0 border-right-0">Month</a> <a
													href="index.jsp#" class="small_blue_btn radius_0">Week</a>
											</div>
										</div>
									</div>
									<div class="white_card_body">
												...
												<table class="table lms_table_active2  ">
													...
													<tbody>
														...
														<tr>
															...
															<td>-0.454 USD</td>
															<td>₹25.00</td>
															<td><a href="index.jsp#" class="status_btn">Success</a>
															</td>
														</tr>
													</tbody>
												</table>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="footer_iner text-center">
							<p>
								2020 © Influence - Designed by <a href="index.jsp#"> <i
									class="ti-heart"></i>
								</a><a href="index.jsp#"> DashboardPack</a>
							</p>
						</div>
					</div>
				</div>
	...
	<div id="back-top" style="display: none;">
		<a title="Go to Top" href="index.jsp#"> <i class="ti-angle-up"></i>
		</a>
	</div>
