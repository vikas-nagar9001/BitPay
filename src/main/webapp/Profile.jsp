...
String profileEmail = (String) session1.getAttribute("profileEmail");
String profileName =  (String) session1.getAttribute("profileName");
String profilePassword =  (String) session1.getAttribute("profilePassword");
String profileMobile =  (String) session1.getAttribute("profileMobile");
String profileAddress =  (String) session1.getAttribute("profileAddress");
String profileAccount =  (String) session1.getAttribute("profileAccount");
String profileFunds =  (String) session1.getAttribute("profileFunds");
String profilePin =  (String) session1.getAttribute("profilePin");
...
<body class="crm_body_bg">
        ...
        <ul id="sidebar_menu">
            <li class>
               <li class><a href="IndexEntry" aria-expanded="false">
					...
					<div
						...
						<div
							...
							<div class="header_notification_warp d-flex align-items-center">
								<!----------refesh button-------------------->
								<li>
									<button type="button" class="refreshbutton"onclick="window.location.href='ProfileEntry';">
								...
								<li><a class="bell_notification_clicker nav-link-notify"
									...
									<div class="notification_Header"
											...
											<button type="button" class="refreshicon"
												onclick="window.location.href='ProfileEntry';">
											<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
											fill="currentColor" class="bi bi-arrow-repeat"
											viewBox="0 0 16 16">
                                              <path
										...
										<div class="nofity_footer">
											<div class="submit_button text-center pt_20">
												<a href="Trader_Profile.jsp#" class="btn_1 green">See
													More</a>
											</div>
										</div>
									</div></li>
							...
							<div class="profile_info d-flex align-items-center">
								...
								<div class="profile_info_iner">
									...
									<div class="profile_info_details">
										<a href="Trader_Profile.jsp#">My Profile </a> <a
											href="Trader_Profile.jsp#">Settings</a> <a
				...
				<div class="row">
					<div class="col-12">
						<div class="main-title mb_30">
							<h3 class="m-0">Welcome Back, <%=profileName %></h3>
						</div>
					</div>
					<div class="col-lg-6 ">
						<div class="white_card card_height_100 mb_30">
							...
							<div class="white_card_body">
								<div class="d-flex mb_30 border_bottom_1px pb-3">
									<div class="flex-shrink-0">
										<img class="me-3 rounded-circle me-0 me-sm-3"
											src="img/transfer/4.png" alt width="60" height="60">
									</div>
									<div class="flex-grow-1">
										<span>Hello</span>
										<h4 class="mb-2"><%=profileName %></h4>
										<p class="mb-1">
											<span><i class="fa fa-phone me-2 text-primary"></i></span> 
											<%=profileMobile %>
										</p>
										<p class="mb-1">
											<span><i class="fa fa-envelope me-2 text-primary"></i></span>
											<a
								...
								<ul class="card-profile__info">
									<li>
										<h5 class="me-4">Address</h5> <span class="text-muted"><%=profileAddress %>
											</span>
									</li>
									<li class="mb-1">

										<h4 class="me-4">Account-Details</h4> <span><b>
												State bank of India</b></span><br> <span> Account number :-
											<%=profileAccount %></span><br> <span> UPI ID : <%=profileAccount%>@bitpay</span><br>
										<span>Password : <%=profilePassword %></span>

									</li>
									<li>
										<h5 class="text-danger me-4">Last Log</h5> <span
										class="text-danger">3 september, 2024 10:00 PM</span>
									</li>
								</ul>
							</div>
						</div>
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<label class="form-label">Bank</label> <select
											class="nice_Select2 nice_Select_line wide mb_20"
											>
											<option value="1"><b>Select-your-Bank</b></option>
									...
									<h7>Funds = Rs <%=profileFunds %></h7>
									<div class="col-12">
										<div class="create_report_btn mt_30">
											<a href="Trader_Profile.jsp#" class="btn_1 w-100">SEND</a>
										</div> 
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="footer_iner text-center">
							<p>
								2020 Â© Influence - Designed by <a href="Trader_Profile.jsp#">
									<i class="ti-heart"></i>
								</a><a href="Trader_Profile.jsp#"> DashboardPack</a>
							</p>
						</div>
					</div>
				</div>
	...
	<div id="back-top" style="display: none;">
		<a title="Go to Top" href="Trader_Profile.jsp#"> <i
			class="ti-angle-up"></i>
		</a>
	</div>
